/*
	...
	Author:       Gerald R. Tamayo, 2005/2009/2010/2023
...
void usage( void )
{
	...
	fprintf(stderr, "\n\n where n = bitsize of num codes added to CODE_MAX = %u.", CODE_MAX);
...
int main( int argc, char *argv[] )
{
	...
	init_get_buffer();
	if ( nfread == 0 ) goto done_compression;
...
void copyright( void )
{
	fprintf(stderr, "\n\n :: lzwgt file compressor, Gerald R. Tamayo, 2005-2023\n");
}
